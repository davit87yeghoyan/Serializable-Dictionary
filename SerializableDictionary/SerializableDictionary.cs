...
namespace Serializable_Dictionary.SerializableDictionary
{
	...
	public class SerializableDictionaryDrawerSettingAttribute : PropertyAttribute
	{
		...
		public SerializableDictionaryDrawerSettingAttribute(bool keyDisable, Type type = null, string methodName = null)
		{
